...
<div class="payment">
        ...
        <div class="payment-col">
            ...
            <div class="formpayment">
                ...
                <div class="wrapper">
                    ...
                    <input type="radio" name="payment_metode" id="option-2" value="bayar ditempat" onclick="return alert('Jika anda memilih metode pembayaran ditempat maka anda harus membayar 50% terlebih dahulu')">
    ...
    <div class="payment-col1">
        ...
        <div class="payment-col3">
            ...
            <div class="detailp">
                <p>Check-out</p>
                <input type="date" id="date2" value="" name="checkout" onchange="getDays()">
                @error('checkout')
                <span style="color: red; font-style:italic; text-align: ">{{ $message}} </span>
            @enderror
            </div>
            ...
            <div>
                <input type="hidden" name="gross_amount" id="total2">
